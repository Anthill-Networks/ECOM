            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <p className="text-2xl font-semibold text-[#0d2946]">
            ...
            <nav className="flex" aria-label="Tabs">
              ...
              <button
                ...
                className={`flex-1 sm:flex-none px-6 py-4 text-sm font-medium border-b-2 transition-colors
                  ${activeTab === "reviews" ? 'border-green-500 text-[#0d2946]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
              ...
              <div className="space-y-6">
                ...
                {isLoggedIn ? (
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-md">
                    <p>Please <button onClick={() => navigate('/login')} className="text-[#0d2946] hover:underline">login</button> to submit a review</p>
                  </div>
                )}
