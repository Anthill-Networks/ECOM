      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="bg-[#bd565e] text-white py-3 rounded-lg text-lg font-medium hover:bg-[#703337] transition duration-200"
          >
            {addingToCart ? (
          ...
          <button
            ...
            disabled={buyingNow}
            className="bg-[#0d2946] text-white py-3 rounded-lg text-lg font-medium hover:bg-[#0a1e38] transition duration-200"
          >
            {buyingNow ? (
              <div className="flex items-center justify-center">
